...
The data set under study describes the fungal invasion of 35 apples. It contains 7 different variables, regarding:
  - characteristics of the apple (variety, weight, radius)
  - strain of the fungi, separated in 4 types (A, B, C and D)
